...
const CLASS_NAME_LAYOUT_FIXED = 'partials-fixed'
const CLASS_NAME_NAVBAR_FIXED = 'partials-navbar-fixed'
const CLASS_NAME_NAVBAR_SM_FIXED = 'partials-sm-navbar-fixed'
const CLASS_NAME_NAVBAR_MD_FIXED = 'partials-md-navbar-fixed'
const CLASS_NAME_NAVBAR_LG_FIXED = 'partials-lg-navbar-fixed'
const CLASS_NAME_NAVBAR_XL_FIXED = 'partials-xl-navbar-fixed'
const CLASS_NAME_FOOTER_FIXED = 'partials-footer-fixed'
const CLASS_NAME_FOOTER_SM_FIXED = 'partials-sm-footer-fixed'
const CLASS_NAME_FOOTER_MD_FIXED = 'partials-md-footer-fixed'
const CLASS_NAME_FOOTER_LG_FIXED = 'partials-lg-footer-fixed'
const CLASS_NAME_FOOTER_XL_FIXED = 'partials-xl-footer-fixed'
